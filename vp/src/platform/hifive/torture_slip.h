#ifndef RISCV_VP_TORTURE_SLIP_H
#define RISCV_VP_TORTURE_SLIP_H
...
class TortureSLIP : public sc_core::sc_module {
public:
	enum {
	...
	tlm_utils::simple_target_socket<TortureSLIP> tsock;

	TortureSLIP(sc_core::sc_module_name, uint32_t, SymbolicContext &_ctx,
	            std::ifstream *upper = nullptr,
...
private:
	...
	void create_input(std::ifstream *stream, size_t pktsiz);
